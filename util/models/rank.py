...
class ValorantRank(Rank):
    ...
    ASCENDANT_1 = 19, ("a1", "ascendant one")
    ASCENDANT_2 = 20, ("a2", "ascendant two")
    ASCENDANT_3 = 21, ("a3", "ascendant three")
    IMMORTAL_1 = 22, ("im1", "immortal one")
    IMMORTAL_2 = 23, ("im2", "immortal two")
    IMMORTAL_3 = 24, ("im3", "immortal three")
